  ...
  return <section id="pricing-plan">
   <div className="container">
    <div className="pricing__top">
        <h2 className="section__title">Membership <span className="highlights">Pricing</span> Plan
        </h2>
    ...
    <div className="pricing__wrapper">
        <div className="pricing__item" data-aos='fade-up' data-aos-duration='1500'>
            ...
            <div className="services">
                <ul>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>Unlimited Access</li>
        ...
        <div className="pricing__item pricing__item-02" data-aos='fade-up' data-aos-duration='1800'>
            ...
            <div className="services">
                <ul>
                    ...
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>Customer Support</li>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>Personal Trainer</li>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>Template Updates</li>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>7 classes per week </li>
                </ul>
                <button className="register__btn">Join Now</button>
            </div>
        </div>
        ...
        <div className="pricing__item pricing__item-03 " data-aos='fade-up' data-aos-duration='2000'>
            ...
            <div className="services">
                <ul>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>Unlimited Access</li>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>Priority Listing</li>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>Personal Trainer</li>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>Template Updates</li>
                    <li><span><i class="ri-checkbox-blank-circle-fill"></i></span>7 classes per week</li>
                </ul>
