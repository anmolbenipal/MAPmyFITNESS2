    ...
    <div className="container">
        <div className="hero__wrapper">
            <div className="hero__content">
                 ...
                 <p data-aos='fade-up' data-aos-delay='100' data-aos-duration='1800'>Trying to lose weight, tone up, lower your BMI, or invest in your overall health?<br/>We give you the right features to get there.</p>
